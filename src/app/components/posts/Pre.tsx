  ...
  return (
    <div ref={textInput} className="relative">
      <button
        ...
        type="button"
        className={clsxm(
          "absolute right-3 bottom-3 z-50 h-9 w-9 rounded border bg-gray-200 p-1 hover:bg-gray-300",
          copied
      ...
      >
        <svg
          ...
          stroke="currentColor"
          aria-hidden="true"
          className={clsxm(copied ? "text-green-400" : "text-gray-700")}
        >
          {copied ? (
            <>
              <path
      ...
      <pre
        className={clsxm(
          "pre mt-4 mb-4 overflow-x-auto rounded-lg bg-gray-200 px-3 py-4 font-mono",
          className
        )}
        {...props}
      />
